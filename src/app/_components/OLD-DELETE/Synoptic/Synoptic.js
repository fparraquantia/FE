      ...
      <Box
        ...
        <Box
          sx={{
            ...
            display: "flex",
            justifyContent: "space-between",
            borderBottom: "2px solid #cccccc44",
          }}>
          <Box
            component="p"
            sx={{ fontWeight: "700" }}>
          ...
          <Box
            ...
            <Box
              ...
              {showAssetsLibrary ? (
                <BiSolidUpArrow
                  size={16}
                  onClick={() => setShowAssetsLibrary(!showAssetsLibrary)}
                />
              ) : (
                <BiSolidDownArrow
                  size={16}
              ...
              <Box
                ...
                <Box
                  sx={{
                    width: "6rem",
                    height: "6rem",
                    boxShadow: "2px 2px 5px 5px #00000033",
                    borderRadius: "8px",
                  }}>
                  <Image
                    src={boiler}
          ...
          <Box
            ...
            <Box
              ...
              {showProcessData ? (
                <BiSolidUpArrow
                  size={16}
                  onClick={() => setShowProcessData(!showProcessData)}
                />
              ) : (
                <BiSolidDownArrow
                  size={16}
