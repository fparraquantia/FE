...
import mockGraph from "../../assets/manualEntry/mockGraph.png";
import boiler from "../../assets/manualEntry/asset1.png";
import heatexchanger from "../../assets/manualEntry/asset5.png";
    ...
    fetch(
      ...
      .then((response) => {
        if (response.status === 201) {
          setModal(false);
          alert("Manual entry uploaded successfully");
        }
      })
